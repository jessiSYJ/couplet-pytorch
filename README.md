This is a simple project use seq2seq-att model to play couplets (对对联)。Inspired by [seq2seq-couplet](https://github.com/wb14123/seq2seq-couplet) and written with PyTorch.
